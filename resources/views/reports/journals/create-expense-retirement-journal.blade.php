                    ...
                    <div class="card card-earnings">
                        <div class="card-header bg-faded">
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <h4 class="card-title">Expense Retirement Journals</h4>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12 mr-3">
                                    <table class="table table-sm table-bordered">
                                                <p class="lead font-weight-bold mt-3">Expense Retirements Journal: &nbsp;
                                                    <span>{{JournalController::generateExpenseRetirementJournalNo()}}</span>
                                                ...
                                                <thead style="max-width: 30px;">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="text-center">Change Bank Accounts</th>
                                                    </tr>
                                                </thead> 
                                                <tbody>
                                                    @foreach($expense_retirements as $ret)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td scope="col" class="text-right">
                                                                {{number_format($ret->amount_paid/1.18,2)}}
                                                            </td>
                                                            @elseif($ret->vat == 'VAT Exclusive')
                                                            <td scope="col" class="text-right">
                                                                {{number_format($ret->amount_paid - $ret->vat_amount,2)}}
                                                            </td>
                                                            @else
                                                            <td scope="col" class="text-right">
                                                                {{number_format($ret->amount_paid,2)}}
                                                            </td>
                                                            @endif
                                                            <td></td>

                                                            <td scope="col" class="text-center">
                                                                <select ret-no="{{$ret->ret_no}}" name="account_id" class="form-control change-accounts btn btn-sm" style="border: none; height: 23px; width: 80px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if($ret->vat == 'VAT Inclusive')
                                                            <td scope="col" class="text-right">
                                                                {{numbeer_format($ret->vat_amount,2)}}
                                                            </td>
                                                            @elseif($ret->vat == 'VAT Exclusive')
                                                            <td scope="col" class="text-right">
                                                                {{number_format($ret->vat_amount,2)}}
                                                            </td>
                                                            @else
                                                            <td scope="col" class="text-right">
                                                                {{$ret->vat_amount}}
                                                ...
                                                @endforeach
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td scope="col" class="text-right font-weight-bold">{{number_format(JournalController::getTotalofExpenseRetirements(),2)}}</td>
                                                            <td scope="col" class="text-right font-weight-bold">{{number_format(JournalController::getTotalofExpenseRetirements(),2)}}</td>
                                                            <td></td> 
                                                        </tr>
                                            ...
                                            <form action="{{url('expense-retirement-journal/report')}}" method="POST">
                                                @csrf
                                                <input type="hidden" name="journal_no" value="{{JournalController::generateExpenseRetirementJournalNo()}}">
                                                ...
                                                Post Expense Retirement Journal
                                                </button>
