            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-earnings">
                        ...
                        <div class="py-4 m-2">
                                <p class="lead font-weight-bold">Expense Retirements Journal
                                    <span class="float-right mb-2">
                                        <a style="border-radius:0 !important; margin-left: 10px !important;" target="__blank" class="btn btn-sm btn-primary print-expense-retirement-journal-report float-right ml-5 mt-2" href="{{url('journal/expense-retirement-report/'.$journal_no)}}">
                                            <span>
                                                <i style="cursor: pointer;" class="material-icons  md-2 align-middle">print</i>
                                            </span>
                                            Print
                                        </a>
                                        <a style="border-radius:0 !important; margin-left: 10px !important; background: #218452;" target="__blank" class="btn btn-sm text-white float-right ml-5 mt-2" href="{{route('export-expense-retirement-journal',$journal_no)}}">
                                            <span>
