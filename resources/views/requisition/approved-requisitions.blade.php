                    ...
                    <div class="card card-earnings">
                        <div class="card-header bg-faded">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <h4 class="card-title">Approved Requisitions</h4>
                                </div>
                            </div>
                        </div>
                            <div class="py-4">
                                <div class="table-responsive">
                                    ...
                                    <form action="{{ route('approved_filter_by_date') }}" method="POST" class="form-inline ml-4">
                                        @csrf
                            ...
                            <table id="data-table" class="table table-bordered table-sm table-striped table-dark mb-0">
                                    ...
                                    <tbody>
                                        @foreach($approved_requisitions as $requisition)
                                            <tr>
